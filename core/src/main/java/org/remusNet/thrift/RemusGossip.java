...
public class RemusGossip {
  ...
  public interface Iface {
    ...
    public void addPeer(PeerInfo info) throws BadPeerName, org.apache.thrift.TException;

    public void delPeer(String peerName) throws org.apache.thrift.TException;

    public List<PeerInfo> getPeers() throws org.apache.thrift.TException;

    public void ping(List<PeerInfo> workers) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void addPeer(PeerInfo info, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.addPeer_call> resultHandler) throws org.apache.thrift.TException;
    ...
    public void ping(List<PeerInfo> workers, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.ping_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client implements org.apache.thrift.TServiceClient, Iface {
    ...
    public void send_addPeer(PeerInfo info) throws org.apache.thrift.TException
    {
    ...
    public List<PeerInfo> recv_getPeers() throws org.apache.thrift.TException
    {
      org.apache.thrift.protocol.TMessage msg = iprot_.readMessageBegin();
      if (msg.type == org.apache.thrift.protocol.TMessageType.EXCEPTION) {
        org.apache.thrift.TApplicationException x = org.apache.thrift.TApplicationException.read(iprot_);
    ...
    public void send_ping(List<PeerInfo> workers) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addPeer(PeerInfo info, org.apache.thrift.async.AsyncMethodCallback<addPeer_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class addPeer_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public addPeer_call(PeerInfo info, org.apache.thrift.async.AsyncMethodCallback<addPeer_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getPeers_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<PeerInfo> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void ping(List<PeerInfo> workers, org.apache.thrift.async.AsyncMethodCallback<ping_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class ping_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<PeerInfo> workers;
      public ping_call(List<PeerInfo> workers, org.apache.thrift.async.AsyncMethodCallback<ping_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class addPeer_args implements org.apache.thrift.TBase<addPeer_args, addPeer_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public addPeer_args(addPeer_args other) {
      if (other.isSetInfo()) {
        this.info = new PeerInfo(other.info);
      }
    }
    ...
    public addPeer_args setInfo(PeerInfo info) {
      this.info = info;
      return this;
    }
  ...
  public static class getPeers_result implements org.apache.thrift.TBase<getPeers_result, getPeers_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public getPeers_result(getPeers_result other) {
      if (other.isSetSuccess()) {
        List<PeerInfo> __this__success = new ArrayList<PeerInfo>();
    ...
    public void addToSuccess(PeerInfo elem) {
      if (this.success == null) {
        this.success = new ArrayList<PeerInfo>();
      }
      this.success.add(elem);
    }

    public List<PeerInfo> getSuccess() {
      return this.success;
    }

    public getPeers_result setSuccess(List<PeerInfo> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<PeerInfo>)value);
        }
        break;
            ...
            if (field.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                this.success = new ArrayList<PeerInfo>(_list20.size);
                for (int _i21 = 0; _i21 < _list20.size; ++_i21)
                {
                  PeerInfo _elem22;
                  _elem22 = new PeerInfo();
                  _elem22.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (PeerInfo _iter23 : this.success)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
  ...
  public static class ping_args implements org.apache.thrift.TBase<ping_args, ping_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public ping_args(ping_args other) {
      if (other.isSetWorkers()) {
        List<PeerInfo> __this__workers = new ArrayList<PeerInfo>();
        for (PeerInfo other_element : other.workers) {
          __this__workers.add(new PeerInfo(other_element));
        }
    ...
    public java.util.Iterator<PeerInfo> getWorkersIterator() {
      return (this.workers == null) ? null : this.workers.iterator();
    }

    public void addToWorkers(PeerInfo elem) {
      if (this.workers == null) {
        this.workers = new ArrayList<PeerInfo>();
      }
      this.workers.add(elem);
    }

    public List<PeerInfo> getWorkers() {
      return this.workers;
    }

    public ping_args setWorkers(List<PeerInfo> workers) {
      this.workers = workers;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case WORKERS:
        if (value == null) {
          ...
          setWorkers((List<PeerInfo>)value);
        }
        break;
            ...
            if (field.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                this.workers = new ArrayList<PeerInfo>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  PeerInfo _elem26;
                  _elem26 = new PeerInfo();
                  _elem26.read(iprot);
                  this.workers.add(_elem26);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.workers != null) {
        oprot.writeFieldBegin(WORKERS_FIELD_DESC);
        {
          ...
          for (PeerInfo _iter27 : this.workers)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
