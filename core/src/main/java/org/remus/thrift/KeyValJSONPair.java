...
public class KeyValJSONPair implements org.apache.thrift.TBase<KeyValJSONPair, KeyValJSONPair._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new KeyValJSONPairStandardSchemeFactory());
    schemes.put(TupleScheme.class, new KeyValJSONPairTupleSchemeFactory());
  }

  public String key; // required
  public String valueJson; // required
  public long jobID; // required
  public long emitID; // required
  ...
  private static class KeyValJSONPairStandardSchemeFactory implements SchemeFactory {
    public KeyValJSONPairStandardScheme getScheme() {
      return new KeyValJSONPairStandardScheme();
    }
  }

  private static class KeyValJSONPairStandardScheme extends StandardScheme<KeyValJSONPair> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, KeyValJSONPair struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // VALUE_JSON
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.valueJson = iprot.readString();
              struct.setValueJsonIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          ...
          case 4: // EMIT_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.emitID = iprot.readI64();
              struct.setEmitIDIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, KeyValJSONPair struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.valueJson != null) {
        oprot.writeFieldBegin(VALUE_JSON_FIELD_DESC);
        oprot.writeString(struct.valueJson);
        oprot.writeFieldEnd();
      }
  ...
  private static class KeyValJSONPairTupleSchemeFactory implements SchemeFactory {
    public KeyValJSONPairTupleScheme getScheme() {
      return new KeyValJSONPairTupleScheme();
    }
  }

  private static class KeyValJSONPairTupleScheme extends TupleScheme<KeyValJSONPair> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, KeyValJSONPair struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, KeyValJSONPair struct) throws org.apache.thrift.TException {
